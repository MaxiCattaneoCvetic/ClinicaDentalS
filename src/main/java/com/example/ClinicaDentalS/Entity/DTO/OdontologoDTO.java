...
public class OdontologoDTO {
    ...
    public OdontologoDTO(int numero_matricula, String nombre, String apellido) {
        this.numero_matricula = numero_matricula;
        this.nombre = nombre;
        this.apellido = apellido;
    }

    public OdontologoDTO(Long id, int numero_matricula, String nombre, String apellido) {
        this.id = id;
        this.numero_matricula = numero_matricula;
        this.nombre = nombre;
        this.apellido = apellido;
